...
(define (lt arr ptr) (list arr (- ptr 1)))
(define (plus arr ptr) (list (set-current-byte arr ptr (+ (current-byte arr ptr) 1)) ptr))
(define (minus arr ptr) (list (set-current-byte arr ptr (- (current-byte arr ptr) 1)) ptr))
